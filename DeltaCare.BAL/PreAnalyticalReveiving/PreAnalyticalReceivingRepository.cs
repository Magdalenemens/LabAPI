...
{
    public class PreAnalyticalReceivingRepository : IPreAnalyticalReceivingRepository
    {
        private readonly IDataRepository _dataRepository;
        private readonly IOrderRepository _orderRepository;
        public PreAnalyticalReceivingRepository(IDataRepository dataRepository, IOrderRepository orderRepository)
        {
        ...
        public async Task<int> UpdatePreAnalyticalReceiving(Object[] ORDs, string ACCN, string REQ_CODE, string SECT, int ATRID, string ORD_NO, string SITE_NO, string U_ID)
        {
            ...
            oRD_DTLModel.PRCVD_DTTM = DateTime.Now;// Convert.ToDateTime(atrJson["RCVD_DTTM"]);
            oRD_DTLModel.STS = "PR";
            oRD_DTLModel.R_STS = "O";
            oRD_DTLModel.PRCVD_ID = U_ID;
            //string STS = "CR";
