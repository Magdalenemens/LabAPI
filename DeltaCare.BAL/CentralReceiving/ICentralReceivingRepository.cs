...
{
    public interface ICentralReceivingRepository
    {
        ...
        Task<int> UpdateCentralReceiving(Object[] ORDs, string ACCN, string REQ_CODE, string SECT, int ATRID, string ORD_NO, string SITE_NO, string U_ID);
    }
}
